...
public class DocumentService {
    ...
    public Document getDocument(int id) {
        return documentRepository.findById(id).orElseThrow(() -> new DataException("Document with id: " + id +" don't exist!"));
    }
    ...
    public void updateDocument(Document document) {
        Document existingDocument = documentRepository.findById(document.getDocument_id()).orElseThrow(
                () -> new DataException("Document with id: " + document.getDocument_id() +" don't exist!"));
