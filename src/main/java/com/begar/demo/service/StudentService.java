...
public class StudentService {
    ...
    public Student getStudent(int id) {
        return studentRepository.findById(id).orElseThrow(() -> new NoDataException("Student with id: " + id + " don't exist!"));
    }
    ...
    public void addStudent(Student student, int id) {
        Group group = groupRepository.findById(id).orElseThrow(() -> new NoDataException("Group with id: " + id + " don't exist!"));
    ...
    public void updateStudent(Student student) {
        Student existingStudent = studentRepository.findById(student.getStudent_id()).orElseThrow(
                () -> new NoDataException("Student with id: " + student.getStudent_id() + " don't exist!"));
